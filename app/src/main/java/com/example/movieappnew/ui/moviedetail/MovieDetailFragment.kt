package com.example.movieappnew.ui.moviedetail
...
import com.example.movieappnew.databinding.FragmentMovieDetailBinding
...
class MovieDetailFragment : Fragment(R.layout.fragment_movie_detail) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.txtLanguage.text = "Lamguage: ${args.language}"
        binding.txtRating.text = "${args.voteAverage} ${args.voteCount} (Reviews)"
        binding.txtReleased.text = "Realeased ${args.realeaseDate}"
